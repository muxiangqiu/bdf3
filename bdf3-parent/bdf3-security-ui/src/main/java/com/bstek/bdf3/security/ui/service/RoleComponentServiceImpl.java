 ...
 * @since 2016年7月12日
 */
@Service("ui.roleComponentService")
public class RoleComponentServiceImpl implements RoleComponentService {
	...
	@CacheEvict({Constants.COMPONENT_MAP_CACHE_KEY,Constants.COMPONENT_ATTRIBUTE_MAP_CACHE_KEY, Constants.COMPONENT_ATTRIBUTE_BY_TARGET_CACHE_KEY})
	@Override
