...
DROP TABLE bdf3_url;
CREATE TABLE bdf3_url (id_ varchar(64) NOT NULL, description_ varchar(255), icon_ varchar(255), name_ varchar(64), navigable_ bit, order_ int, parent_id_ varchar(64), path_ varchar(512), PRIMARY KEY (id_)) ENGINE=MyISAM DEFAULT CHARSET=utf8;
INSERT INTO bdf3_url (id_, description_, icon_, name_, navigable_, order_, parent_id_, path_) VALUES ('cafb93bb-15d6-4737-aec0-0d500aaeb8e5', null, 'fa fa-database blue-text', '云数据库', true, 9, null, 'bdf3.dbconsole.view.DbConsoleMaintain.d');
INSERT INTO bdf3_url (id_, description_, icon_, name_, navigable_, order_, parent_id_, path_) VALUES ('c7cb63b4-eb12-4d72-b943-aac6acbd4f6c', null, 'fa fa-book yellow-text', '字典管理', true, 8, null, 'bdf3.dictionary.ui.view.DictionaryMaintain.d');
INSERT INTO bdf3_url (id_, description_, icon_, name_, navigable_, order_, parent_id_, path_) VALUES ('e9db79a1-571a-4804-9111-ae9b17680b95', null, 'fa fa-file-excel-o orange-text', '导入管理', true, 7, null, 'bdf3.importer.view.ImporterSolutionMaintain.d');
INSERT INTO bdf3_url (id_, description_, icon_, name_, navigable_, order_, parent_id_, path_) VALUES ('6fd00879-07f0-4e30-8109-c405fead4d30', null, 'fa fa-clock-o blue-text', '日志查询', true, 9, null, 'bdf3.log.view.LogInfoMaintain.d');
INSERT INTO bdf3_url (id_, description_, icon_, name_, navigable_, order_, parent_id_, path_) VALUES ('07efe0f8-1d7c-483c-bc3c-54e87f9f285b', null, 'fa fa-user blue-text', '用户管理', true, 1, null, 'bdf3.security.ui.view.UserMaintain.d');
INSERT INTO bdf3_url (id_, description_, icon_, name_, navigable_, order_, parent_id_, path_) VALUES ('1491d097-0795-4a0f-8608-7b452f8ac2be', null, 'fa fa-bars yellow-text', '菜单管理', true, 2, null, 'bdf3.security.ui.view.UrlMaintain.d');
INSERT INTO bdf3_url (id_, description_, icon_, name_, navigable_, order_, parent_id_, path_) VALUES ('2f858c99-1253-498b-801d-aa5c4f021542', null, 'fa fa-user-md blue-text', '角色管理', true, 3, null, 'bdf3.security.ui.view.RoleMaintain.d');
INSERT INTO bdf3_url (id_, description_, icon_, name_, navigable_, order_, parent_id_, path_) VALUES ('328d6a2a-3acf-4501-b621-5687f1b057e1', null, 'fa fa-code-fork green-text', '菜单权限', true, 4, null, 'bdf3.security.ui.view.RoleUrlMaintain.d');
INSERT INTO bdf3_url (id_, description_, icon_, name_, navigable_, order_, parent_id_, path_) VALUES ('4523af08-01f0-44f5-be89-3b2241da0e9e', null, 'fa fa-shield yellow-text', '权限分配', true, 5, null, 'bdf3.security.ui.view.PermissionMaintain.d');
INSERT INTO bdf3_url (id_, description_, icon_, name_, navigable_, order_, parent_id_, path_) VALUES ('46f0ee9b-04a8-41f2-9008-81efa3fa2fe1', null, 'fa fa-graduation-cap blue-text', '角色分配', true, 6, null, 'bdf3.security.ui.view.RoleAssignmentMaintain.d');
INSERT INTO bdf3_url (id_, description_, icon_, name_, navigable_, order_, parent_id_, path_) VALUES ('8b9f683f-b8e6-4eee-8cad-4fd8475860d4', null, 'fa fa-tachometer red-text', '个人中心', true, 15, null, 'bdf3.security.ui.view.PersonalCenter.d');
